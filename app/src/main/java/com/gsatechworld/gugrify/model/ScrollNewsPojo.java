...
public class ScrollNewsPojo {
    ...
    public class ScrollNews {
        ...
        @SerializedName("text15")
        @Expose
        private String text15;
        @SerializedName("text16")
        @Expose
        private String text16;
        @SerializedName("text17")
        @Expose
        private String text17;
        @SerializedName("text18")
        @Expose
        private String text18;
        @SerializedName("text19")
        @Expose
        ...
        @SerializedName("text27")
        @Expose
        private String text27;
        @SerializedName("text28")
        @Expose
        private String text28;
        @SerializedName("text29")
        @Expose
        private String text29;
        @SerializedName("text30")
        @Expose
