...
import static com.gsatechworld.gugrify.view.DisplayBreakingNewsActivity.postDetails;

public class DisplaySharedPosts extends AppCompatActivity implements MediaPlayer.OnCompletionListener, MediaPlayer.OnBufferingUpdateListener {
    ...
    static LinearLayout pausePlayLayout;
    TextView textView;
...
//        getWindow().getDecorView().setSystemUiVisibility(View.SYSTEM_UI_FLAG_HIDE_NAVIGATION);
        sharedPreferences = NewsSharedPreferences.getInstance(DisplaySharedPosts.this);
        ...
        if (viewPager != null && postDetails.getResult() != null && postDetails.getResult().get(0).getSelection().equalsIgnoreCase("image_arrays")) {
            ...
            b = new BreakingNewsViewPagerAdapter(DisplaySharedPosts.this, postDetails.getResult().get(0).getImageArray());
            ...
            for (int i = 0; i < dotscount; i++) {
                ...
                dots[i] = new ImageView(DisplaySharedPosts.this);
                dots[i].setImageDrawable(ContextCompat.getDrawable(DisplaySharedPosts.this, R.drawable.non_active_dot));
            ...
            dots[0].setImageDrawable(ContextCompat.getDrawable(DisplaySharedPosts.this, R.drawable.active_dot));
            ...
            viewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
                ...
                public void onPageSelected(int position) {
                    ...
                    dots[position].setImageDrawable(ContextCompat.getDrawable(DisplaySharedPosts.this, R.drawable.active_dot));
...
//            zoomIn.setRepeatCount(Animation.INFINITE);
                ...
                call.enqueue(new Callback<CityWiseAdvertisement>() {
                    ...
                    public void onResponse(Call<CityWiseAdvertisement> call, Response<CityWiseAdvertisement> response) {
                        ...
                        if (response.isSuccessful()) {
                            ...
                            Toast.makeText(DisplaySharedPosts.this, "Server error!!", Toast.LENGTH_SHORT);
        ...
        call.enqueue(new Callback<PostDetailPojo>() {
            ...
            public void onResponse(Call<PostDetailPojo> call, Response<PostDetailPojo> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    Toast.makeText(DisplaySharedPosts.this, "Server error!!", Toast.LENGTH_SHORT).show();
    ...
    public void onBackPressed() {
        ...
        if (getRequestedOrientation() == ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE)
            ...
            Intent intent = new Intent(DisplaySharedPosts.this, DashboardActivity.class);
    ...
    public void showAds() {
        ...
        dialog = new Dialog(DisplaySharedPosts.this, R.style.NewDialog);
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                if (active) {
                    dialog.show();
                    Glide.with(DisplaySharedPosts.this).load(results.get(random).getImage()).into(dialogImage);
                    dialogUrlButton.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View view) {
                            Intent intent = new Intent(DisplaySharedPosts.this, ActivityShowWebView.class);
                    ...
                    if (results.get(random).getAudio().trim().isEmpty()) {
                        ...
                        if (dialog.isShowing()) {
                            ...
                            new DisplaySharedPosts.PlayMainAdAsync().execute(results.get(random).getAudio());
                            mediaPlayer.setOnBufferingUpdateListener(DisplaySharedPosts.this);
                            mediaPlayer.setOnCompletionListener(DisplaySharedPosts.this);
                        }
                    }
                }
            }
        ...
        call.enqueue(new Callback<TwentyPostsByCategory>() {
            ...
            public void onResponse(Call<TwentyPostsByCategory> call, Response<TwentyPostsByCategory> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    if (recycler != null) {
                        adapter = new BreakingNewsRecyclerAdapter(DisplaySharedPosts.this, posts);
                        recycler.setLayoutManager(new LinearLayoutManager(DisplaySharedPosts.this, LinearLayoutManager.VERTICAL, false));
                        recycler.setAdapter(adapter);
                    }

                } else {
                    Toast.makeText(DisplaySharedPosts.this, "Server error!!", Toast.LENGTH_LONG).show();
...
//                    tv_top_news.startAnimation(anim);
                    ...
                    Glide.with(DisplaySharedPosts.this).load(postDetails.getResult().get(0).getReporterPic()).into(place_holder_image);
